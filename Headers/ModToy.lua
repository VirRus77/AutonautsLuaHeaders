...
function ModToy.RegisterForCustomCallback ( UniqueName, CallbackType, Callback )
end
...
function ModToy.UpdateModelParameters ( UniqueName, Scale, RotX, RotY, RotZ, TransX, TransY, TransZ )
end
...
---@param RotY number Rotation (Y) of the model - Defaults to 0
---@param RotZ number Rotation (Z) of the model - Defaults to 0
function ModToy.UpdateModelRotation ( UniqueName, RotX, RotY, RotZ )
end
...
---@param UniqueName string The unique name of the custom item - Required
---@param Scale number Scale of the model - Defaults to 1
function ModToy.UpdateModelScale ( UniqueName, Scale )
end
...
function ModToy.UpdateModelScaleSplit ( UniqueName, ScaleX, ScaleY, ScaleZ )
end
...
function ModToy.UpdateModelTranslation ( UniqueName, TransX, TransY, TransZ )
end
