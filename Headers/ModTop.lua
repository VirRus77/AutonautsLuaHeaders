...
-- Version: 135.8
---@param UniqueName string The unique and corresponding name of the top - Required
---@param NewIngredientsStringArr? string[] List of ingredients required to make the top - Defaults to none
...
---@param ModelName string The name/path of the custom model to use or name/path of the in game model to use - Defaults to in game 'Lumberjack' Model
---@param UsingCustomModel boolean True if using a custom model, false if using in game model/default model - Defaults to true
function ModTop.CreateTop ( UniqueName, NewIngredientsStringArr, NewIngredientsAmountArr, ModelName, UsingCustomModel )
end
...
function ModTop.RegisterForCustomCallback ( UniqueName, CallbackType, Callback )
end
...
function ModTop.UpdateModelParameters ( UniqueName, Scale, RotX, RotY, RotZ, TransX, TransY, TransZ )
end
...
---@param RotY number Rotation (Y) of the model - Defaults to 0
---@param RotZ number Rotation (Z) of the model - Defaults to 0
function ModTop.UpdateModelRotation ( UniqueName, RotX, RotY, RotZ )
end
...
---@param UniqueName string The unique name of the custom item - Required
---@param Scale number Scale of the model - Defaults to 1
function ModTop.UpdateModelScale ( UniqueName, Scale )
end
...
function ModTop.UpdateModelScaleSplit ( UniqueName, ScaleX, ScaleY, ScaleZ )
end
...
function ModTop.UpdateModelTranslation ( UniqueName, TransX, TransY, TransZ )
end
