...
function ModEducation.RegisterForCustomCallback ( UniqueName, CallbackType, Callback )
end
...
function ModEducation.UpdateModelParameters ( UniqueName, Scale, RotX, RotY, RotZ, TransX, TransY, TransZ )
end
...
---@param RotY number Rotation (Y) of the model - Defaults to 0
---@param RotZ number Rotation (Z) of the model - Defaults to 0
function ModEducation.UpdateModelRotation ( UniqueName, RotX, RotY, RotZ )
end
...
---@param UniqueName string The unique name of the custom item - Required
---@param Scale number Scale of the model - Defaults to 1
function ModEducation.UpdateModelScale ( UniqueName, Scale )
end
...
function ModEducation.UpdateModelScaleSplit ( UniqueName, ScaleX, ScaleY, ScaleZ )
end
...
function ModEducation.UpdateModelTranslation ( UniqueName, TransX, TransY, TransZ )
end
