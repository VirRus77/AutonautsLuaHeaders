...
function ModMedicine.RegisterForCustomCallback ( UniqueName, CallbackType, Callback )
end
...
function ModMedicine.UpdateModelParameters ( UniqueName, Scale, RotX, RotY, RotZ, TransX, TransY, TransZ )
end
...
---@param RotY number Rotation (Y) of the model - Defaults to 0
---@param RotZ number Rotation (Z) of the model - Defaults to 0
function ModMedicine.UpdateModelRotation ( UniqueName, RotX, RotY, RotZ )
end
...
---@param UniqueName string The unique name of the custom item - Required
---@param Scale number Scale of the model - Defaults to 1
function ModMedicine.UpdateModelScale ( UniqueName, Scale )
end
...
function ModMedicine.UpdateModelScaleSplit ( UniqueName, ScaleX, ScaleY, ScaleZ )
end
...
function ModMedicine.UpdateModelTranslation ( UniqueName, TransX, TransY, TransZ )
end
