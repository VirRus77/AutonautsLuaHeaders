...
-- Version: 135.8
---@param UniqueName string The unique and corresponding name of the hat - Required
---@param NewIngredientsStringArr? string[] List of ingredients required to make the hat - Defaults to none
...
---@param ModelName string The name/path of the custom model to use or name/path of the in game model to use - Defaults to in game 'Dinosaur' Model
---@param UsingCustomModel boolean True if using a custom model, false if using in game model/default model - Defaults to true
function ModHat.CreateHat ( UniqueName, NewIngredientsStringArr, NewIngredientsAmountArr, ModelName, UsingCustomModel )
end
...
function ModHat.RegisterForCustomCallback ( UniqueName, CallbackType, Callback )
end
...
function ModHat.UpdateModelParameters ( UniqueName, Scale, RotX, RotY, RotZ, TransX, TransY, TransZ )
end
...
---@param RotY number Rotation (Y) of the model - Defaults to 0
---@param RotZ number Rotation (Z) of the model - Defaults to 0
function ModHat.UpdateModelRotation ( UniqueName, RotX, RotY, RotZ )
end
...
---@param UniqueName string The unique name of the custom item - Required
---@param Scale number Scale of the model - Defaults to 1
function ModHat.UpdateModelScale ( UniqueName, Scale )
end
...
function ModHat.UpdateModelScaleSplit ( UniqueName, ScaleX, ScaleY, ScaleZ )
end
...
function ModHat.UpdateModelTranslation ( UniqueName, TransX, TransY, TransZ )
end
