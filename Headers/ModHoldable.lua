...
-- Version: 134.28
---@param UniqueName string The unique and corresponding name of the holdable - Required
---@param NewIngredientsStringArr string[] List of ingredients required to make the holdable - Defaults to none
...
---@param ModelName string The name/path of the custom model to use or name/path of the in game model to use - Defaults to in game 'Butter' Model
---@param UsingCustomModel boolean True if using a custom model, false if using in game model/default model - Defaults to true
function ModHoldable.CreateHoldable ( UniqueName, NewIngredientsStringArr, NewIngredientsAmountArr, ModelName, UsingCustomModel )
end
...
function ModHoldable.RegisterForCustomCallback ( UniqueName, CallbackType, Callback )
end
...
function ModHoldable.UpdateModelParameters ( UniqueName, Scale, RotX, RotY, RotZ, TransX, TransY, TransZ )
end
...
---@param RotY number Rotation (Y) of the model - Defaults to 0
---@param RotZ number Rotation (Z) of the model - Defaults to 0
function ModHoldable.UpdateModelRotation ( UniqueName, RotX, RotY, RotZ )
end
...
---@param UniqueName string The unique name of the custom item - Required
---@param Scale number Scale of the model - Defaults to 1
function ModHoldable.UpdateModelScale ( UniqueName, Scale )
end
...
function ModHoldable.UpdateModelScaleSplit ( UniqueName, ScaleX, ScaleY, ScaleZ )
end
...
function ModHoldable.UpdateModelTranslation ( UniqueName, TransX, TransY, TransZ )
end
